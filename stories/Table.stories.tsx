...
import { Table } from "../src/solid-daisy-components/components/Table";
const meta = {
      ...
      >
        <div>
          ...
          <p class="text-sm text-base-content/70">
            Click headers to sort, checkboxes to select. Selected:{" "}
            {selectedRows().length}
          </p>
        </div>
              ...
              <For each={sortedEmployees()}>
                {(employee) => (
                  <tr
                    ...
                    classList={{
                      "hover:bg-base-200": !selectedRows().includes(
                        employee.id,
                      ),
                    }}
                  >
                    ...
                    <td>
                      <Badge
                        color={getStatusBadgeColor(employee.status) as any}
                        size="sm"
                      >
                        {employee.status}
                      </Badge>
