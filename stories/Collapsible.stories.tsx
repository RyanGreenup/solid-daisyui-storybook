...
import { Collapsible } from "../src/solid-daisy-components/components/Collapsible";
  ...
  render: () => (
    <div style={{ display: "flex", "flex-direction": "column", gap: "1.5rem" }}>
      <Collapsible variant="default" title="Default Variant">
        <p>
          This uses the default styling with a subtle border and background.
        </p>
      </Collapsible>

      <Collapsible variant="card" title="Card Variant">
        <p>
          This variant has a card-like appearance with shadow and enhanced
          background.
        </p>
      </Collapsible>
      ...
      <Collapsible variant="outline" title="Outline Variant">
        <p>
          Clean outline style with transparent background and prominent border.
        </p>
      </Collapsible>

      <Collapsible variant="ghost" title="Ghost Variant">
        <p>
          Minimal styling with transparent background, perfect for subtle
          disclosure.
        </p>
      </Collapsible>
    </div>
    ...
    return (
      <div style={{ display: "flex", "flex-direction": "column", gap: "1rem" }}>
        <div class="flex gap-2">
          <Button size="sm" onClick={() => handleToggle(!isExpanded())}>
            {isExpanded() ? "Collapse" : "Expand"} Externally
          </Button>
          <Badge color="primary">Expanded {expandCount()} times</Badge>
        </div>
          ...
          <Alert color="info" showIcon={false}>
            <div>
              ...
              <p class="text-sm mt-1">
                This collapsible's state is controlled by the button above. You
                can also click the header to toggle it.
              </p>
            </div>
          </Alert>
        </Collapsible>
    ...
    const faqs = [
      {
        ...
        answer:
          "SolidJS is easy to learn! Start by installing it with `npm create solid@latest my-app`, then explore the reactive primitives like createSignal and createEffect. The syntax is similar to React but with fine-grained reactivity.",
        category: "Beginner",
      },
      {
        id: "performance",
        ...
        answer:
          "SolidJS uses fine-grained reactivity, which means only the specific parts of the DOM that need to update actually do. There's no virtual DOM overhead, and the compiler optimizes your code for maximum performance.",
      ...
      },
      {
        ...
        answer:
          "Absolutely! SolidJS has first-class JSX support. The JSX is compiled to efficient DOM operations. You get all the benefits of declarative templates with the performance of imperative updates.",
      ...
      },
      {
        ...
        answer:
          "SolidJS has a growing ecosystem with solid-router for routing, solid-meta for head management, and many other packages. The community is friendly and active on Discord and GitHub.",
        category: "Community",
      },
    ];
...
export const DisabledState: Story = {
  render: () => (
    <div style={{ display: "flex", "flex-direction": "column", gap: "1rem" }}>
      ...
      >
        <p>
          This content is accessible and can be expanded or collapsed normally.
        </p>
      </Collapsible>
...
export const WithoutIcon: Story = {
  render: () => (
    ...
    >
      <p>
        This collapsible doesn't show the chevron icon, creating a cleaner look.
      </p>
    </Collapsible>
  ),
};
