          ...
          <div class="space-y-4">
            <div>
              <div class="flex justify-between mb-2">
                ...
                <Badge color="error" class="text-xs">
                  {red()}
                </Badge>
              </div>
              <Range
            ...
            <div>
              <div class="flex justify-between mb-2">
                ...
                <Badge color="success" class="text-xs">
                  {green()}
                </Badge>
              </div>
              <Range
            ...
            <div>
              <div class="flex justify-between mb-2">
                ...
                <Badge color="info" class="text-xs">
                  {blue()}
                </Badge>
              </div>
              <Range
        ...
        <Card.Body>
          ...
          <div class="space-y-4">
            ...
            <div class="flex gap-2">
              ...
              <Button size="sm" variant="outline" onClick={() => setVolume(0)}>
                Min
              </Button>
              <Button size="sm" variant="outline" onClick={() => setVolume(50)}>
                50%
              </Button>
              <Button
                size="sm"
              ...
              <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                  <div class="flex justify-between mb-2">
                    ...
                    <Badge color="secondary" class="text-xs">
                      ${maxPrice()}
                    </Badge>
                  </div>
                  <Range
          ...
          <div class="space-y-6">
            ...
            <div>
              <div class="flex justify-between mb-2">
                ...
                <Badge color="accent" class="text-xs">
                  {reverb()}%
                </Badge>
              </div>
              <Range
            ...
            <div>
              <div class="flex justify-between mb-2">
                ...
                <Badge color="warning" class="text-xs">
                  {distortion()}%
                </Badge>
              </div>
              <Range
