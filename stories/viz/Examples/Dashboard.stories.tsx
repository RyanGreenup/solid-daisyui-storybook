...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: 'A comprehensive merchandising dashboard for hardware retailers showcasing stock levels, sales performance, and operational metrics.',
      },
    },
  },
...
const generateInventoryData = () => {
  const products = [
    { name: 'Phillips Head Screwdriver Set', sku: 'PHS-001', category: 'Hand Tools', stock: 45, reorderLevel: 25, price: 24.99 },
    { name: 'DeWalt Cordless Drill 20V', sku: 'DWT-CD20', category: 'Power Tools', stock: 12, reorderLevel: 15, price: 149.99 },
    { name: '1/4" Hex Bolts (100pk)', sku: 'HB-025-100', category: 'Fasteners', stock: 234, reorderLevel: 50, price: 18.50 },
    { name: 'PVC Pipe Cutter', sku: 'PVC-CUT-01', category: 'Plumbing', stock: 8, reorderLevel: 20, price: 32.99 },
    { name: 'Wire Stripper Tool', sku: 'WS-PRO-15', category: 'Electrical', stock: 67, reorderLevel: 30, price: 19.99 },
    { name: 'Garden Hose 50ft', sku: 'GH-50-RUB', category: 'Garden & Outdoor', stock: 23, reorderLevel: 15, price: 45.99 },
    { name: 'Interior Paint Primer Gallon', sku: 'IP-PRIM-GAL', category: 'Paint & Supplies', stock: 156, reorderLevel: 75, price: 28.99 },
    { name: 'Cabinet Hinges (2pk)', sku: 'CH-STD-2PK', category: 'Hardware', stock: 89, reorderLevel: 40, price: 12.99 },
    { name: 'Safety Glasses Clear', sku: 'SG-CLR-STD', category: 'Safety Equipment', stock: 145, reorderLevel: 100, price: 8.99 },
    { name: 'Adjustable Wrench 12"', sku: 'AW-12-CHR', category: 'Hand Tools', stock: 34, reorderLevel: 25, price: 34.99 },
    { name: 'Circular Saw Blades (5pk)', sku: 'CSB-7.25-5', category: 'Power Tools', stock: 28, reorderLevel: 20, price: 42.99 },
    { name: 'Drywall Screws 2" (50pk)', sku: 'DS-2IN-50', category: 'Fasteners', stock: 167, reorderLevel: 60, price: 15.99 },
    { name: 'Pipe Wrench 14"', sku: 'PW-14-STL', category: 'Plumbing', stock: 19, reorderLevel: 15, price: 56.99 },
    { name: 'Extension Cord 25ft', sku: 'EC-25-12G', category: 'Electrical', stock: 41, reorderLevel: 30, price: 38.99 },
    { name: 'Lawn Mower Blade', sku: 'LMB-21-UNI', category: 'Garden & Outdoor', stock: 15, reorderLevel: 12, price: 24.99 },
  ];

  return products.map(product => ({
    ...product,
    status: product.stock <= product.reorderLevel ? 'low' : product.stock <= product.reorderLevel * 1.5 ? 'medium' : 'high',
  ...
  render: () => {
    ...
    const kpis = createMemo(() => {
      ...
      return {
        ...
        outOfStockItems,
        totalSkus,
        stockFillRate: ((totalSkus - outOfStockItems) / totalSkus * 100).toFixed(1)
      };
    });
      ...
      <div class="min-h-screen bg-base-200/30">
        <Layout>
          ...
          <MainWrapper>
              ...
              <SidebarContent class="p-4">
                <div class="mb-6">
                  <div class="flex items-center gap-3 mb-4">
                    ...
                    <span class="font-bold text-base-content">Hardware Pro</span>
                  </div>
                ...
                <nav class="space-y-1">
                  <a href="#" class="flex items-center gap-3 px-3 py-2 rounded-lg text-primary bg-primary/10 font-medium">
                ...
                <div class="mt-8 p-3 bg-warning/10 rounded-lg border border-warning/20">
                  <div class="flex items-center gap-2 mb-2">
                    ...
                    <span class="text-sm font-medium text-warning">Stock Alert</span>
                  </div>
            ...
            {/* Charts Section */}
            <section class="mb-8">
              <h2 class="text-2xl font-bold text-base-content mb-6">Sales & Performance Analytics</h2>
            ...
            <section class="mb-8">
              <h2 class="text-2xl font-bold text-base-content mb-6">Category Performance</h2>
              <Card class="bg-base-100 border border-base-300">
                <Card.Body>
            ...
            <section class="mb-8">
              <h2 class="text-2xl font-bold text-base-content mb-6">Inventory Management</h2>
              <Card class="bg-base-100 border border-base-300">
                <Card.Body>
            ...
            {/* Store Performance */}
            <section>
              <h2 class="text-2xl font-bold text-base-content mb-6">Store Performance Overview</h2>
              <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-5 gap-4">
                {storeData().map((store, index) => (
                  <Card class="bg-base-100 border border-base-300">
                    <Card.Body class="text-center">
                      <h3 class="font-bold text-lg text-base-content mb-2">{store.store}</h3>
                      <div class="space-y-2">
                        <div>
                          <div class="text-2xl font-bold text-success">${(Number(store.revenue) / 1000).toFixed(0)}K</div>
                        ...
                        <div class="flex justify-between text-sm">
                          ...
                          <span class="font-medium">${store.avgOrderValue}</span>
                        </div>
                        <div class="flex justify-between text-sm">
        ...
        <div class="max-w-7xl mx-auto">
          <header class="mb-8">
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-4">
                ...
                <div>
                  <h1 class="text-3xl font-bold text-base-content">Hardware Pro</h1>
                  <p class="text-base-content/60">Merchandising Dashboard</p>
                </div>
              </div>
              <div class="text-right">
                <div class="text-lg font-bold text-success">${todaySales.toLocaleString()}</div>
          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            ...
            <Stats class="bg-base-100 border border-base-300">
              <Stat>
                <StatFigure><DollarSign class="w-6 h-6 text-success" /></StatFigure>
                <StatTitle>7-Day Total</StatTitle>
                <StatValue class="text-success">${(totalSales / 1000).toFixed(0)}K</StatValue>
            ...
            <Stats class="bg-base-100 border border-base-300">
              <Stat>
                <StatFigure><AlertTriangle class="w-6 h-6 text-warning" /></StatFigure>
            ...
            <Stats class="bg-base-100 border border-base-300">
              <Stat>
                <StatFigure><ShoppingCart class="w-6 h-6 text-info" /></StatFigure>
                  ...
                  {inventoryAlerts.map((item, index) => (
                    <div class="flex items-center justify-between p-3 bg-base-200/50 rounded-box">
                      <div class="flex-1">
                        ...
                        <div class="text-xs text-base-content/60">{item.category} • {item.sku}</div>
                      </div>
