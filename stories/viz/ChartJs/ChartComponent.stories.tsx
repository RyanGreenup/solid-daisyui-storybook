...
import ChartComponent from "../../../src/solid-daisy-components/components/viz/chart_js/ChartComponent";
      ...
      >
        ...
        <div class="bg-info text-info-content p-4 rounded-box">
          ...
          <p class="text-sm">
            ...
            directly with a full Chart.js configuration object. This approach
            gives you complete control over all Chart.js features but requires
            more setup than the wrapper components like{" "}
            <code class="bg-info-content text-info px-1 rounded">
              LineChart
            </code>{" "}
            or{" "}
            <code class="bg-info-content text-info px-1 rounded">BarChart</code>
            .
          </p>
        </div>
      </div>
