...
export const InteractiveExample: Story = {
  render: () => {
    const [chartType, setChartType] = createSignal<"vertical" | "horizontal">(
      "vertical",
    );
      ...
      >
        <Fieldset class="bg-base-200 border border-base-300 p-4 rounded-box">
          ...
          <Label class="text-sm opacity-70 mt-3">
            {chartType() === "horizontal" ? "Horizontal" : "Vertical"} bar chart
            with {datasetCount()} dataset{datasetCount() > 1 ? "s" : ""}
