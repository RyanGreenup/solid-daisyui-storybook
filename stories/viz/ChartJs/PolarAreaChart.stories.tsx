...
export const InteractiveExample: Story = {
  render: () => {
    ...
    const [colorScheme, setColorScheme] = createSignal<"vibrant" | "dark">(
      "vibrant",
    );
        ...
        <Fieldset class="bg-base-200 border border-base-300 p-4 rounded-box min-w-80">
          ...
          <div class="flex flex-col gap-4">
            ...
            <Label class="text-sm opacity-70 border-t border-base-300 pt-3 text-wrap">
              <div class="flex flex-col gap-2">
                <strong>Current:</strong> {data[dataType()].title} with{" "}
                {colorScheme()} colors
          ...
          <div class="mt-4 text-xs opacity-60">
            <p>
              <strong>Polar Area Charts</strong> excel at:
            </p>
...
export const CustomStyling: Story = {
  render: () => {
    return (
      <div
        style={{ height: "600px" }}
        class="bg-gradient-to-br from-slate-900 to-slate-700 p-6 rounded-box"
      >
        <PolarAreaChart
