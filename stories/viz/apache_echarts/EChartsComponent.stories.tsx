...
export const InteractiveAdvanced: Story = {
  render: () => {
    const [chartType, setChartType] = createSignal<"line" | "bar" | "scatter">(
      "line",
    );
      ...
      >
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div>
              ...
              <Select
                ...
                value={chartType()}
                onChange={(e) =>
                  setChartType(e.target.value as "line" | "bar" | "scatter")
                }
              >
        ...
        <div class="bg-info text-info-content p-4 rounded-box">
          ...
          <p class="text-sm">
            ...
            with reactive data and options. Apache ECharts provides powerful
            visualization capabilities with excellent performance, rich
            interactions, and extensive customization options. The option object
            is completely reactive to SolidJS signals.
          </p>
        </div>
      </div>
    );
