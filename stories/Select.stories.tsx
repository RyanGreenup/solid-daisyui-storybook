...
export const SolidJSReactive: Story = {
  render: () => {
    ...
    const getFrameworkInfo = () => {
      ...
      const messages = {
        solid:
          "Great choice! SolidJS offers fine-grained reactivity with excellent performance.",
        react:
          "Popular choice! React has a huge ecosystem and community support.",
        ...
        angular:
          "Angular offers a complete framework with TypeScript by default.",
      };
      ...
      >
        ...
        >
          ...
          <div class="bg-base-300 p-4 rounded-box">
            ...
            <div>
              <strong>Runtime:</strong> {selectedRuntime() || "None selected"}
            </div>
          </div>
            ...
            >
              <Alert color="success">
                <span>
                  ...
                  , and{" "}
                  <strong>
                    {runtimes.find((r) => r.value === selectedRuntime())?.label}
                  </strong>
                  .
                </span>
              </Alert>
